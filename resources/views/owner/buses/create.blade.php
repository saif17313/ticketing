        ...
        <header class="bg-white shadow-sm border-b border-gray-200">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                <div class="flex justify-between items-center">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-800">Add New Bus</h1>
                        <p class="text-sm text-gray-600 mt-1">Register a new bus to your fleet</p>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-8 border border-gray-200">
                <form method="POST" action="{{ route('owner.buses.store') }}">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="bus_number" id="bus_number" value="{{ old('bus_number') }}" class="w-full px-4 py-2.5 border @error('bus_number') border-red-500 @else border-gray-300 @enderror rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500" placeholder="e.g., DHAKA-001" required>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="bus_model" id="bus_model" value="{{ old('bus_model') }}" class="w-full px-4 py-2.5 border @error('bus_model') border-red-500 @else border-gray-300 @enderror rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500" placeholder="e.g., Volvo B11R" required>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" name="total_seats" id="total_seats" value="{{ old('total_seats') }}" min="10" max="60" class="w-full px-4 py-2.5 border @error('total_seats') border-red-500 @else border-gray-300 @enderror rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500" placeholder="e.g., 40" required>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="amenities" id="amenities" rows="3" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500" placeholder="e.g., WiFi, TV, Charging ports">{{ old('amenities') }}</textarea>
                    ...
                    <div class="flex justify-end gap-3 pt-6 border-t border-gray-200">
                        ...
                        <button type="submit" class="px-6 py-2.5 bg-green-600 text-white rounded-lg hover:bg-green-700 font-medium">Create Bus</button>
                    </div>
                </form>
            </div>
        </main>
