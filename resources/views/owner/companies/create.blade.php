...
<head>
    ...
    <title>Add New Company - BD Bus Tickets</title>
        ...
        <header class="bg-gradient-to-r from-green-500 to-green-600 shadow-lg">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                <div class="flex justify-between items-center">
                    <div>
                        <h1 class="text-3xl font-bold text-white"> Add New Company</h1>
                        <p class="text-green-100 text-sm mt-1">Register your bus company</p>
                    </div>
        ...
        <main class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                <div class="mb-8 pb-6 border-b border-gray-200">
                    ...
                    <p class="text-gray-600">Fill in the details below to register your bus company</p>
                </div>
                <form method="POST" action="{{ route('owner.companies.store') }}">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name') }}" class="w-full px-4 py-3 border @error('name') border-red-500 @else border-gray-300 @enderror rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 transition" placeholder="e.g., Green Line Paribahan" required>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="email" name="email" id="email" value="{{ old('email') }}" class="w-full px-4 py-3 border @error('email') border-red-500 @else border-gray-300 @enderror rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 transition" placeholder="e.g., info@greenline.com" required>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="phone" id="phone" value="{{ old('phone') }}" class="w-full px-4 py-3 border @error('phone') border-red-500 @else border-gray-300 @enderror rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 transition" placeholder="e.g., 01712345678" required>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="address" id="address" rows="3" class="w-full px-4 py-3 border @error('address') border-red-500 @else border-gray-300 @enderror rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 transition" placeholder="e.g., 123 Motijheel, Dhaka-1000" required>{{ old('address') }}</textarea>
                    ...
                    <div class="mb-8">
                        ...
                        <input type="text" name="license_number" id="license_number" value="{{ old('license_number') }}" class="w-full px-4 py-3 border @error('license_number') border-red-500 @else border-gray-300 @enderror rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 transition" placeholder="e.g., LIC-2025-001" required>
                    ...
                    <div class="flex justify-end gap-4 pt-6 border-t border-gray-200">
                        ...
                        <button type="submit" class="px-8 py-3 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-xl hover:from-green-600 hover:to-green-700 transition font-semibold shadow-md hover:shadow-lg transform hover:-translate-y-0.5"> Create Company</button>
                    </div>
                </form>
            </div>
        </main>
