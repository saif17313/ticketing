...
<head>
    ...
    <title>Edit Schedule - BD Bus Tickets</title>
    ...
    <div class="min-h-screen">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-sm text-gray-600 mt-1">Update schedule information</p>
                    </div>
        ...
        <main class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="bg-white rounded-lg shadow-sm p-8 border border-gray-200">
                <form method="POST" action="{{ route('owner.schedules.update', $schedule) }}">
                    @csrf
                    @method('PUT')
                    <div class="mb-6">
                        ...
                        <select name="bus_id" id="bus_id" class="w-full px-4 py-2.5 border @error('bus_id') border-red-500 @else border-gray-300 @enderror rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500" required>
                            ...
                            @foreach($buses as $bus)
                                <option value="{{ $bus->id }}" {{ old('bus_id', $schedule->bus_id) == $bus->id ? 'selected' : '' }}>{{ $bus->bus_number }} ({{ $bus->route->sourceDistrict->name }}  {{ $bus->route->destinationDistrict->name }}) - {{ $bus->company->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="date" name="journey_date" id="journey_date" value="{{ old('journey_date', $schedule->journey_date->format('Y-m-d')) }}" class="w-full px-4 py-2.5 border @error('journey_date') border-red-500 @else border-gray-300 @enderror rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500" required>
                    ...
                    <div class="grid grid-cols-2 gap-6 mb-6">
                        <div>
                            ...
                            <input type="time" name="departure_time" id="departure_time" value="{{ old('departure_time', substr($schedule->departure_time, 0, 5)) }}" class="w-full px-4 py-2.5 border @error('departure_time') border-red-500 @else border-gray-300 @enderror rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500" required>
                        ...
                        <div>
                            ...
                            <input type="time" name="arrival_time" id="arrival_time" value="{{ old('arrival_time', substr($schedule->arrival_time, 0, 5)) }}" class="w-full px-4 py-2.5 border @error('arrival_time') border-red-500 @else border-gray-300 @enderror rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500" required>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="number" name="base_fare" id="base_fare" value="{{ old('base_fare', $schedule->base_fare) }}" min="100" max="10000" step="0.01" class="w-full px-4 py-2.5 border @error('base_fare') border-red-500 @else border-gray-300 @enderror rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500" required>
                    ...
                    <div class="mb-6">
                        ...
                        <select name="status" id="status" class="w-full px-4 py-2.5 border @error('status') border-red-500 @else border-gray-300 @enderror rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500" required>
                            ...
                            <option value="arrived" {{ old('status', $schedule->status) == 'arrived' ? 'selected' : '' }}>Arrived</option>
                    ...
                    <div class="flex justify-end gap-3 pt-6 border-t border-gray-200">
                        ...
                        <button type="submit" class="px-6 py-2.5 bg-green-600 text-white rounded-lg hover:bg-green-700 font-medium">Update Schedule</button>
                    </div>
                </form>
            </div>
        </main>
