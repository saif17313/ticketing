...
<body class="bg-gray-50">
    <div class="min-h-screen">
        ...
        <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            @if(isset($schedules))
                <!-- Search Summary with Day Navigation -->
                        ...
                        <div class="flex-1">
                            ...
                            <div class="flex items-center gap-4 mt-2">
                                ...
                                <div class="flex items-center gap-2">
                                    <form method="POST" action="{{ route('search.buses') }}" class="inline">
                                        @csrf
                                        ...
                                        <input type="hidden" name="journey_date" value="{{ \Carbon\Carbon::parse($validated['journey_date'])->subDay()->format('Y-m-d') }}">
                                        <input type="hidden" name="bus_type" value="{{ request('bus_type') }}">
                                        <input type="hidden" name="sort_by" value="{{ request('sort_by') }}">
                                        <button type="submit" 
                                                @if(\Carbon\Carbon::parse($validated['journey_date'])->isToday()) disabled @endif
                                                class="p-2 rounded-lg border border-gray-300 hover:bg-gray-50 transition disabled:opacity-50 disabled:cursor-not-allowed"
                                                title="Previous Day">
                                    ...
                                    <form method="POST" action="{{ route('search.buses') }}" class="inline">
                                        ...
                                        <input type="hidden" name="from_district_id" value="{{ $validated['from_district_id'] }}">
                                        <input type="hidden" name="to_district_id" value="{{ $validated['to_district_id'] }}">
                                        <input type="hidden" name="journey_date" value="{{ \Carbon\Carbon::parse($validated['journey_date'])->addDay()->format('Y-m-d') }}">
                                        <input type="hidden" name="bus_type" value="{{ request('bus_type') }}">
                                        <input type="hidden" name="sort_by" value="{{ request('sort_by') }}">
                                        <button type="submit" 
